...
function RayfieldLibrary:CreateWindow(Settings)
    ...
    local ImageLink = "https://tr.rbxcdn.com/b2353801bdbd70141d266659476af713/420/420/Decal/Png" -- Replace this with the image link you want to display
    ...
    ImageFrame.Size = UDim2.new(1, 0, 0, 10)
	...
	if Settings.Discord then
		...
		if not isfile(SynCityFolder.."/Discord Invites".."/"..Settings.Discord.Invite..ConfigurationExtension) then
			...
			if Settings.Discord.RememberJoins then -- We do logic this way so if the developer changes this setting, the user still won't be prompted, only new users
				writefile(SynCityFolder.."/Discord Invites".."/"..Settings.Discord.Invite..ConfigurationExtension,"Rayfield RememberJoins is true for this invite, this invite will not ask you to join again")
			end
		else
